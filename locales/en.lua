Locales['en'] = {
  ...
  ['gave_item'] = 'Dali jste ~z~%sx ~r~%s ~s~%s',
  ['received_item'] = 'Obdrželi jste ~g~%sx ~y~%s ~s~od %s',
  ...
  ['gave_ammo'] = 'dali jste %sx nábojů %s.',
  ['received_ammo'] = 'obdrželi jste %sx nábojů od %s.',
  ['gave_money'] = 'dali jste $%s %s',
  ['received_money'] = 'Obdrželi jste ~g~$%s ~s~od %s',
  ['gave_account_money'] = 'Dali jste ~r~$%s ~s~(%s) %s',
  ...
  ['threw_money'] = 'you threw ~r~$%s cash',
  ['threw_account'] = 'you threw ~r~$%s %s',
  ...
  ['bank'] = 'bankovní účet',
  ['black_money'] = '~r~špinavé peníze~s~',

  ['act_imp'] = 'akce není možná',
  ['in_vehicle'] = 'nemůže nic dát osobě ve vozidle',
  ['cannot_pickup_room'] = 've vašem inventáři není dostatek místa pro %s!',
  ...
  ['money_set'] = 'někdo s vysokou úrovní vám právě nastavil $%s (%s)!',
